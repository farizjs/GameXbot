...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= '<b>' . __('Hai!') . '</b>' . PHP_EOL;
        $text .= __('Untuk memulai, mulai pesan dengan {USAGE} di salah satu obrolan Anda atau klik {BUTTON} tombol dan kemudian pilih obrolan untuk dimainkan.', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
